  ...
  return (
    <div className="chip-family">
      <h4>
        ...
        {props.optional ? <span className="opt"> optional</span> : null}
      </h4>
      <div
        ref={gridRef}
        className="chip-thumb-grid"
        role="listbox"
        ...
        {items.map((item) => {
          ...
          return (
            <button
              ...
              className={`thumb-tile${selected ? " selected" : ""}${item.placeholder ? " placeholder" : ""}${item.id === "" ? " unset" : ""}`}
            ...
            >
              ...
              >
                ...
                {selected ? (
                  <span className="thumb-check" aria-hidden>
                    ✓
                  </span>
                ) : null}
              </span>
...
function ChipGlyph(props: { family: ChipFamily; unset?: boolean }) {
  if (props.unset) {
    return (
      <svg viewBox="0 0 48 48" className="thumb-glyph" aria-hidden>
